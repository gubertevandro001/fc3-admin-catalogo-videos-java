...
public class CreateVideoUseCaseTest extends UseCaseTest {
    ...
    @Test
    public void givenAValidCommandWithoutCategories_whenCallsCreateVideo_shouldReturnsVideoId() {
    ...
    @Test
    public void givenAValidCommandWithoutGenres_whenCallsCreateVideo_shouldReturnsVideoId() {
    ...
    @Test
    public void givenAValidCommandWithoutCastMembers_whenCallsCreateVideo_shouldReturnsVideoId() {
    ...
    @Test
    public void givenAValidCommandWithoutResources_whenCallsCreateVideo_shouldReturnsVideoId() {
    ...
    public void givenAValidCommand_whenCallsCreateVideoAndSomeCastMembersDoesNotExists_shouldReturnDomainException() {
        ...
        final var member = Fixture.CastMember.wesley().getId();
        final var expectedErrorMessage = "Some categories could not be found: %s".formatted(member.getValue());
        final var expectedErrorCount = 1;
        final var expectedTitle = Fixture.title();
        final var expectedDescription = Fixture.Videos.description();
        final var expectedLaunchYear = Fixture.year();
        ...
        final var expectedCategories = Set.of(Fixture.Categories.aulas().getId());
        final var expectedGenres = Set.of(Fixture.Genres.tech().getId());
        final var expectedMembers = Set.of(member);
    ...
    private void mockImageMedia() {
        when(mediaResourceGateway.storeImage(any(), any())).thenAnswer(t -> {
            ...
            return ImageMedia.with(IdUtils.uuid(), resource.getResource().getName(), "/img");
        });
    }
